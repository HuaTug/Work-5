...
type CreateUserRequest struct {
	...
	Password string `thrift:"password,2" form:"password" json:"password" vd:"len($)>5 &&len($)<12"`
}
...
type UpdateUserRequest struct {
	Name     string `thrift:"name,1" form:"name" json:"name" vd:"(len($) > 0 && len($) < 100)"`
	Password string `thrift:"password,3" form:"password" json:"password" vd:"(len($)>5 &&len($)<12)"`
}
...
type LoginUserResponse struct {
	...
	RefreshToken string `thrift:"RefreshToken,4" form:"RefreshToken" json:"RefreshToken" query:"RefreshToken"`
}
...
type GetUserInfoRequest struct {
	UserName string `thrift:"UserName,1" form:"user_name" form:"user_name" json:"user_name"`
}
...
type UserServiceLoginUserArgs struct {
	Req *LoginUserResquest `thrift:"req,1"`
}
